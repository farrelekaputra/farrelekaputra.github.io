        ...
        <div className="container2 pt-5 md:pt-2 w-full bg-white border-2-white flex flex-col mx-auto h-auto justify-center items-center" id="page2" style={{marginTop: "-2px"}}>
            <div className="content2 flex mx-auto w-11/12 md:w-10/12 flex-col">
                ...
                <div className="activity flex flex-row justify-around pt-10 flex-wrap gap-y-6">
                    ...
                    <div key={index} id={portoId} link={portoLink} className="card cursor-pointer flex flex-col p-3 justify-between w-80 h-auto bg-white" onClick={() => sweetAlert(portoId, portoLink)}>
                        ...
                        <h1 className="name text-blue-500 text-left text-2xl font-semibold pt-3">
                            {portoName}
                        </h1>
