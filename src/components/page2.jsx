const Activity = ({Hobi, Header}) => {
    ...
    <div className="page2" id="what-i-do md:-mt-20">
        ...
        <div className="container2 pt-2 w-full relative flex flex-col mx-auto h-auto justify-center items-center bg-gradient-to-b from-blue-600 via-blue-500 to-blue-300" id="page2" style={{marginTop: "-2px"}}>
