    ...
    <div className="page2" id="what-i-do">
        <div className="container2 pt-2 w-full bg-blue-600 flex flex-col mx-auto h-auto justify-center items-center" id="page2" style={{marginTop: "-2px"}}>
            <div className="content2 flex mx-auto w-10/12 flex-col">
                ...
                <div className="activity flex flex-col md:flex-row justify-center md:gap-10 md:pt-10">
                {Hobi.map(({hobiJudul, hobiDeskripsi, hobiImg}, index) => 
                    <div key={index} className="card flex flex-col p-5 justify-center md:w-1/3 gap-1 md:gap-4 h-auto ">
                        <img src={hobiImg} alt={hobiJudul} className="p-4 m-4 rounded-lg bg-white transition-transform w-full md:w-60 duration-200 transform md:hover:scale-110 cursor-pointer" />
